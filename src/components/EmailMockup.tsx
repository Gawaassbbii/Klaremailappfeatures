...
export function EmailMockup() {
  const emails = [
    { from: 'Sarah Martin', subject: 'Votre rapport est disponible nu', time: '09:00', color: '#0066FF' },
    { from: 'Alex Bernard', subject: 'Réunion de demain verschoven', time: '09:00', color: '#00CC88' },
