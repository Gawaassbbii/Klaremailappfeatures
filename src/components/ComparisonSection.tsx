...
const comparisons = [
  { gmail: 'Notifications 24/7', klar: 'Livraisons à 09h & 17h' },
  { gmail: '100+ spams par semaine', klar: '0 spam garanti' },
  { gmail: 'Vos données vendues', klar: 'Vos données privées' },
  { gmail: 'Inbox saturée', klar: 'Auto-nettoyage 30 jours' },
  { gmail: 'Email impossible à modifier', klar: 'Rewind & édition post-envoi' },
];
    ...
    <section className="py-24 px-6 bg-gray-800 text-white relative overflow-hidden border-y border-gray-700">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          ...
          >
            <div className="text-center mb-6">
              <h3 className="text-[32px]">KLAR</h3>
            </div>
            {comparisons.map((item, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <span className="text-[16px]">{item.klar}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
