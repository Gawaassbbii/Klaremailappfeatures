...
export function ZenMode({ onNavigate }: ZenModeProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <h2 className="text-[40px] leading-none tracking-tight mb-4 text-green-900">La solution KLAR</h2>
            <ul className="space-y-3 text-[18px] text-gray-700">
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <p className="text-[18px] text-gray-300">
                Avec KLAR PRO, choisissez vos propres horaires de livraison.
              </p>
            </div>
