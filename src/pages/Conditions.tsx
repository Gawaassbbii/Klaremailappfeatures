      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        >
          <p className="text-[18px] text-gray-700 leading-relaxed">
            Bienvenue sur KLAR. En utilisant nos services, vous acceptez ces conditions. 
        ...
        <div className="space-y-12">
          ...
          >
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
              <p>
                En créant un compte KLAR, vous acceptez ces conditions ainsi que notre 
                Politique de Confidentialité. Si vous n'êtes pas d'accord, n'utilisez pas KLAR.
              </p>
            </div>
          </motion.section>
          ...
          >
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
              <p>
                KLAR est un service d'email qui propose :
              </p>
          ...
          >
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
              ...
              <p>Vous devez avoir au moins 16 ans pour créer un compte KLAR.</p>
          ...
          >
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
              <p><strong>4.1 KLAR Essential (Gratuit)</strong></p>
              <p>Accès gratuit avec fonctionnalités de base. Aucune carte bancaire requise.</p>
              
              <p><strong>4.2 KLAR PRO (5€/mois)</strong></p>
              <p>
          ...
          >
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Tenter de compromettre la sécurité de KLAR</li>
                <li>Utiliser KLAR pour du phishing ou de l'arnaque</li>
              </ul>
          ...
          >
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
              <p>
                Le contenu de KLAR (logo, design, code) est protégé. Vous ne pouvez pas le copier, 
          ...
          >
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
              <p>
                KLAR est fourni "tel quel". Nous faisons de notre mieux pour garantir un service 
          ...
          >
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
              <p>
                ...
                vous seront notifiés par email. Continuer à utiliser KLAR après modification 
