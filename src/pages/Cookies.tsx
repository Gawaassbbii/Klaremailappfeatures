      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        >
          ...
          <p className="text-[18px] text-gray-700 leading-relaxed">
            KLAR utilise le strict minimum de cookies nécessaires au fonctionnement. 
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 bg-green-50 border-2 border-green-500 rounded-2xl">
              ...
              <p className="text-[16px] text-gray-700 mb-4">
                Ces cookies sont indispensables au fonctionnement de KLAR. Sans eux, vous ne pourriez pas vous connecter.
              </p>
              <ul className="space-y-2 text-[16px] text-gray-700">
                <li>• <strong>klar_session</strong> - Gère votre connexion (7 jours)</li>
                <li>• <strong>klar_lang</strong> - Sauvegarde votre langue préférée (1 an)</li>
                <li>• <strong>klar_csrf</strong> - Protection contre les attaques (session)</li>
              </ul>
            </div>
            ...
            <div className="p-6 bg-gray-50 border-2 border-gray-300 rounded-2xl">
              ...
              <p className="text-[16px] text-gray-700 mb-4">
                Nous utilisons une version anonymisée de analytics pour comprendre comment améliorer KLAR. 
                Aucune donnée personnelle n'est collectée.
              </p>
              <ul className="space-y-2 text-[16px] text-gray-700">
                <li>• <strong>_klar_analytics</strong> - Stats anonymes d'utilisation (90 jours)</li>
              </ul>
        ...
        >
          ...
          <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
            <p>
              KLAR utilise certains services externes qui peuvent déposer leurs propres cookies :
            </p>
        ...
        >
          ...
          <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
            ...
            <p className="text-gray-600 text-[16px]">
              ⚠️ Attention : Bloquer les cookies essentiels empêchera KLAR de fonctionner correctement.
            </p>
          </div>
        </motion.section>
