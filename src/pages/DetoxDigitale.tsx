...
export function DetoxDigitale({ onNavigate }: DetoxDigitaleProps) {
  return (
    <div className="min-h-screen bg-white pt-24">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-[48px] leading-none tracking-tight mb-8 text-center">Le système KLAR</h2>
        ...
        >
          ...
          <div className="mt-8 p-4 bg-white rounded-xl text-center">
            <p className="text-[16px] text-gray-700">
              <strong>10 000 utilisateurs KLAR</strong> = 40 tonnes de CO2 économisées par an
            </p>
          </div>
        </motion.div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'Oui ! Les datacenters consomment 1% de l\'électricité mondiale. Moins de stockage = moins d\'énergie = impact réel. KLAR est certifié neutre en carbone.'
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
