...
const blogPosts = [
  {
    title: 'Pourquoi nous avons créé KLAR',
    excerpt: 'L\'histoire de la création de KLAR et notre vision pour l\'avenir de l\'email.',
    date: '15 Nov 2024',
    author: 'Équipe KLAR',
    category: 'Entreprise',
    color: '#0066FF'
  ...
  {
    title: 'Apprendre le néerlandais en gérant ses emails',
  ...
  },
  {
    ...
    excerpt: 'Comment KLAR réduit votre empreinte carbone numérique avec l\'auto-delete.',
    date: '18 Oct 2024',
    author: 'Thomas Green',
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          <h1 className="text-[80px] leading-none tracking-tighter mb-6">Blog KLAR</h1>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-[40px] leading-none tracking-tight mb-4">Newsletter KLAR</h3>
