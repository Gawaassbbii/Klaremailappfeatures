...
const faqs = [
  {
    ...
    questions: [
      {
        q: 'Qu\'est-ce que KLAR ?',
        a: 'KLAR est un service d\'email nouvelle génération qui privilégie votre concentration, votre vie privée et votre bien-être. Nous proposons des fonctionnalités uniques comme le Zen Mode (2 livraisons/jour), le Premium Shield (anti-spam), et l\'immersion linguistique.'
      },
      {
        q: 'KLAR est-il vraiment gratuit ?',
        a: 'Oui ! KLAR Essential est 100% gratuit, sans publicité, pour toujours. Nous proposons également KLAR PRO (5€/mois) pour ceux qui veulent plus de personnalisation et de fonctionnalités avancées.'
      },
      {
        q: 'Puis-je utiliser mon adresse email actuelle ?',
        a: 'Non, KLAR fonctionne uniquement avec des adresses @klar.app. Vous pouvez cependant rediriger vos emails actuels vers KLAR ou utiliser les deux en parallèle pendant la transition.'
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        a: 'Avec KLAR Essential, les horaires sont fixés à 09h00 et 17h00. Avec KLAR PRO, vous pouvez personnaliser complètement vos horaires de livraison.'
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Non, les frais de timbre permettent de financer l\'infrastructure anti-spam de KLAR. C\'est ce qui nous permet de vous garantir 0% de spam sans dépendre de la publicité.'
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        a: 'Actuellement : Néerlandais (NL) et Allemand (DE). Le néerlandais est disponible en version basique dans KLAR Essential. Les deux langues avec vocabulaire avancé sont disponibles dans KLAR PRO.'
      },
      {
      ...
      },
      {
        ...
        a: 'En moyenne 6 mois pour le néerlandais et 8 mois pour l\'allemand, avec une utilisation quotidienne régulière de KLAR. Cela dépend de votre exposition et de votre langue maternelle.'
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        a: 'Avec KLAR Essential (10 secondes), non car c\'est trop rapide. Avec KLAR PRO, une petite mention "Modifié" apparaît discrètement si vous modifiez après 1 minute.'
      },
      {
        q: 'Combien de fois puis-je modifier un email ?',
        a: 'KLAR Essential : une seule suppression dans les 10 secondes. KLAR PRO : modifications illimitées pendant 24h.'
      },
      {
    ...
    questions: [
      {
        ...
        a: 'Essential est gratuit avec les fonctionnalités de base. PRO (5€/mois) offre la personnalisation complète : horaires Zen Mode sur mesure, immersion linguistique illimitée (NL+DE), Rewind 24h, alias premium, signature sans pub.'
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        q: 'KLAR fonctionne-t-il sur mobile ?',
        a: 'Oui ! KLAR est disponible via navigateur web (responsive) et nous préparons des apps iOS et Android natives pour 2025.'
      },
      {
        q: 'Puis-je utiliser KLAR avec mon client email (Outlook, Apple Mail) ?',
        a: 'Pas directement. KLAR fonctionne uniquement via son interface web pour garantir toutes les fonctionnalités (Zen Mode, Rewind, etc.). Nous travaillons sur des intégrations futures.'
      },
      {
        q: 'Quelle est la taille maximale des pièces jointes ?',
        a: 'KLAR Essential : 25 MB par email. KLAR PRO : 100 MB par email. Pour les fichiers plus volumineux, nous recommandons d\'utiliser un service de transfert externe.'
      }
    ]
  }
];
