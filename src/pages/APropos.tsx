  ...
  return (
    <div className="min-h-screen bg-white pt-24">
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        >
          <h1 className="text-[80px] leading-none tracking-tighter mb-6">À propos de KLAR</h1>
        ...
        >
          ...
          <p className="text-[20px] text-gray-700 leading-relaxed">
            KLAR est né à Bruxelles avec une vision simple : redonner le contrôle de leur boîte mail aux utilisateurs. 
        ...
        >
          ...
          <div className="space-y-4 text-[18px] text-gray-700 leading-relaxed">
            <p>
              KLAR a été créé en 2025 à Bruxelles, au cœur de l'Europe. Notre équipe multilingue 
            ...
            <p>
              ...
              à l'essentiel. KLAR signifie "clair" en allemand et "prêt" en néerlandais - deux valeurs 
              qui définissent notre produit.
            </p>
            <p>
              Aujourd'hui, nous servons des milliers d'utilisateurs qui ont retrouvé le plaisir d'une 
              boîte mail propre, sécurisée et intelligente.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-[18px] text-gray-300 mb-6">
            Rejoignez des milliers d'utilisateurs qui ont repris le contrôle de leur inbox.
          </p>
          <motion.button
