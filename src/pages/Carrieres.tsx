...
const jobs = [
  {
    ...
    type: 'Temps plein',
    description: 'Nous recherchons un développeur passionné pour construire l\'avenir de KLAR.',
    color: '#0066FF'
  },
  {
  ...
  },
  {
    ...
    location: 'Remote',
    type: 'Temps plein',
    description: 'Aidez-nous à faire connaître KLAR auprès de millions d\'utilisateurs.',
    color: '#FF6B00'
  },
  {
...
const perks = [
  ...
  {
    title: 'Stock options',
    description: 'Participez à la réussite de KLAR'
  }
];
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          <h1 className="text-[80px] leading-none tracking-tighter mb-6">Rejoignez KLAR</h1>
