      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          ...
          <p className="text-[20px] text-gray-600 max-w-2xl mx-auto mt-4">
            Apprenez le néerlandais et l'allemand en lisant simplement vos emails. Pas d'effort, juste de la répétition naturelle.
          </p>
        </motion.div>
          ...
          <div className="bg-white p-6 rounded-2xl border-2 border-black">
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-xl">
              <p className="text-[14px] text-gray-700">
                📚 <strong>verslag</strong> (NL) = rapport • 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 bg-orange-50 border-2 border-orange-300 rounded-3xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-[32px] tracking-tight">Néerlandais</h3>
                  <p className="text-[16px] text-gray-600">Priorité pour Bruxelles & Belgique</p>
                </div>
              </div>
              <div className="space-y-3 text-[16px] text-gray-700">
                <p>✓ Vocabulaire quotidien (1000+ mots)</p>
                <p>✓ Expressions idiomatiques</p>
                <p>✓ Conjugaisons simples</p>
        ...
        >
          ...
          <p className="text-[18px] text-gray-700 mb-6 max-w-2xl mx-auto">
            Activez l'immersion linguistique dès maintenant. Gratuit pour le néerlandais de base.
          </p>
          <motion.button
