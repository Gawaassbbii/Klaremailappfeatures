    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            <div className="mb-6">
              <h2 className="text-[32px] mb-2">KLAR Essential</h2>
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <span className="text-[16px]">Adresse @klar.app</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-green-600 mt-1 flex-shrink-0" />
          ...
          >
            ...
            <div className="mb-6">
              <h2 className="text-[32px] mb-2">KLAR PRO</h2>
              <p className="text-gray-700 text-[16px]">La puissance complète de KLAR</p>
            </div>
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <span className="text-[16px]">Tout de KLAR Essential, plus :</span>
              </li>
              <li className="flex items-start gap-3">
                <Check size={20} className="text-purple-600 mt-1 flex-shrink-0" />
          ...
          <div className="space-y-6">
            <div className="border border-gray-300 rounded-2xl p-6">
              ...
              <p className="text-[14px] text-gray-600">
                Oui, vous pouvez passer de KLAR Essential à KLAR PRO ou résilier votre abonnement PRO à tout moment.
              </p>
            </div>
            ...
            <div className="border border-gray-300 rounded-2xl p-6">
              <h3 className="text-[18px] mb-2">KLAR Essential est-il vraiment gratuit ?</h3>
              <p className="text-[14px] text-gray-600">
                Oui, KLAR Essential est 100% gratuit pour toujours, avec 5 Go de stockage et accès au Zen Mode limité.
              </p>
            </div>
          </div>
        </div>
