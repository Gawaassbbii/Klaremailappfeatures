      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        >
          ...
          <p className="text-[18px] text-gray-700 leading-relaxed">
            Chez KLAR, votre vie privée n'est pas négociable. Contrairement aux géants de la tech, 
        ...
        <div className="space-y-12">
          ...
          >
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Faire fonctionner le service KLAR</li>
          ...
          >
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
              ...
              <p>
                Pour exercer vos droits : <a href="mailto:privacy@klar.app" className="underline text-blue-600">privacy@klar.app</a>
              </p>
            </div>
          </motion.section>
          ...
          >
            ...
            <div className="text-[18px] text-gray-700 leading-relaxed space-y-4">
              <p>
                KLAR utilise des cookies strictement nécessaires au fonctionnement (authentification, préférences). 
